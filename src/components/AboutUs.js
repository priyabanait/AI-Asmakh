  ...
  return (
    <div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center w-full px-4 md:px-8 mt-10 md:mt-36">
        ...
        <div className="bg-black/10 backdrop-blur-md border border-white/20 rounded-md px-6 md:px-10 py-8 md:py-10 shadow-lg max-w-[900px] mx-auto">
          <h1 className="text-[#10284C] text-[20px] md:text-[30px] lg:text-[30px] font-semibold mb-2">
          BUILDING LEGACY THAT LASTS
          </h1>
          <div className="w-[40%] sm:w-[40%] md:w-[40%] lg:w-[40%] h-[1px] mt-8 bg-gray-400 mb-3 md:mb-4 mx-auto"></div>
        ...
        {/* Stats Cards */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mt-6 md:mt-10 mb-10 md:mb-10">
          {[
            ...
            <div
              key={index}
              className="bg-black/10 backdrop backdrop-blur-md border border-white/20 rounded-md p-4 md:p-6 md:px-14 text-[#10284C]"
            >
              <h2 className="text-xl md:text-2xl font-semibold mb-1">
                {item.value}
              </h2>
              <div className="w-[80%] sm:w-[70%] md:w-[60%] lg:w-[90%] h-[1px] bg-gray-400 my-3 md:mb-4 mx-auto"></div>
              <p className="text-[#10284C] text-xs md:text-sm">
                {item.label}
              </p>
            </div>
          ))}
    ...
    <section className="relative w-full py-10 md:py-10">
      ...
      <div className="bg-white py-12 px-4 sm:px-6 lg:px-8">
        <div className=" mx-auto text-center relative">
          ...
          {/* Title */}
          <h2 className="text-[#10284C] text-[20px] md:text-[30px] lg:text-[30px] font-semibold mb-4 relative">
            OUR VALUE
          
          </h2>
          
          {/* Subtitle */}
          <p className="text-gray-600 text-base md:text-base max-w-4xl mx-auto">
      ...
      <div className="relative w-full min-h-[500px] py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-16">
            {/* Left Box */}
            <div className="bg-black/10  backdrop-blur-md  border-white/20 rounded-md p-6 md:p-8 shadow-lg border">
            ...
            {/* Middle Box */}
            <div className="bg-black/10  backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-gray-200">
              <p className="text-gray-800 text-sm md:text-base leading-relaxed">
    ...
    <section className="w-full flex flex-col items-center py-20 bg-white text-[#001730]">
      {/* Header */}
      <div className="text-center max-w-3xl mb-16">
        <h2 className="text-xl md:text-2xl font-semibold tracking-wide">
          A LEGACY OF EXCELLENCE SINCE 1930
        </h2>
        <div className="w-[30%] sm:w-[30%] md:w-[30%] lg:w-[30%] h-[1px] bg-gray-400 my-3 mx-auto"></div>
      ...
      <div className="relative flex flex-col items-center w-full ">
        ...
        <div className="relative flex flex-col  ">
          <div className="flex flex-col mx-auto md:ml-80 md:flex-row  gap-8 md:gap-16">
            {/* Image */}
            <div className="w-full max-w-[400px] md:w-[400px] h-[250px] relative overflow-hidden mx-auto md:mx-0 shadow-md">
              <Image
                src="/Image (2).png"
                alt="Legacy 1970"
                fill
        ...
        <div className="relative flex flex-col mt-8">
          ...
          {/* Content */}
          <div className="max-w-md mx-auto md:mr-80 text-center md:text-right">
  {/* Heading */}
  ...
  <p className="text-gray-500 mt-4 text-sm md:text-base leading-relaxed">
    ...
    nation's urban evolution.
        ...
        <div className="relative flex flex-col mt-8">
          ...
          {/* Content */}
          <div className="flex flex-col mx-auto md:ml-80 md:flex-row gap-8 md:gap-16 items-start mt-8">
            {/* Image */}
            <div className="w-full max-w-[300px] md:w-[300px] h-[150px] relative overflow-hidden mx-auto md:mx-0 shadow-md">
              <Image
                src="/Image (3).png"
                alt="Legacy 1970"
                fill
...
<div className="hidden md:block relative">
  ...
  <div className="relative w-[150px] h-[100px] md:w-[250px] md:h-[150px] mb-4 shadow-lg rounded z-0">
    ...
    />
        ...
        <div className="w-[30%] sm:w-[30%] md:w-[30%] lg:w-[30%] h-[1px] bg-gray-200 my-3 mx-auto"></div>
        <p className="text-gray-500 mt-3 text-sm md:text-base leading-relaxed">
