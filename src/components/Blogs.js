  ...
  return (
    <div>
      ...
      <section className="relative w-full min-h-[70vh] sm:min-h-[70vh] flex flex-col items-center justify-center overflow-visible">
        ...
        <div className="absolute left-1/2 bottom-[160px] transform -translate-x-1/2 translate-y-1/2 z-20 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] px-4 sm:px-0">
          <div className="bg-[#8C8C8C66] backdrop-blur-md border border-[#8C8C8C66] rounded-md p-10 sm:p-6 md:p-6 shadow-lg">
        ...
        <div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-1/2 z-20 w-full hidden md:flex justify-center px-4 lg:px-10">
          <div className="flex w-full flex-wrap justify-center gap-4 bg-[#8C8C8C66] p-4 lg:mx-24 rounded-md shadow-md">
            {/* Filter Items */}
            {["Type", "Topic", "Categories", "Date"].map((label, index) => (
              <div
                key={index}
                className="flex items-center justify-between bg-[#0B1F3A] text-white px-4 py-3 rounded-md w-[260px] shadow-lg hover:bg-[#10284C] transition"
              >
                <div className="flex items-center gap-3">
                  {/* Icon + Divider */}
                  <div className="flex items-center gap-2">
