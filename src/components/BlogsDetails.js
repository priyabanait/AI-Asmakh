  ...
  return (
    <div>
      ...
      <div className="container-custom mt-10 text-center">
        <h2 className="text-[27px] md:text-[36px] font-bold text-[#10284C] uppercase">
          Similar Blogs
        </h2>
      </div>
        ...
        {blogs.map((blog, i) => (
          ...
          >
            <div className="relative w-full h-80">
              ...
              <button className="absolute top-4 left-3 bg-[#10284C] text-white text-[10px] sm:text-xs font-semibold px-3 py-1.5 rounded flex items-center gap-2 hover:bg-[#1b3a70] transition z-10 shadow-md">
                <span>EXPLORE</span>
                <FaArrowRight size={10} />
              </button>

              <div className="absolute bottom-0 left-0 right-0 bg-[#10284C]/50 backdrop-blur-sm p-4 z-10">
        ...
        <div className="mx-auto px-4 sm:px-6 md:px-12">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <div className="w-[60%] h-[1.5px] bg-gray-300 my-2"></div>
