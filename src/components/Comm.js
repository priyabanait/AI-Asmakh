...
export default function Commercial() {
  ...
  return (
    <div>
      {/* ---------- HERO SECTION ---------- */}
      <section className="relative w-full min-h-[87vh] lg:min-h-[87vh] flex flex-col items-center justify-center overflow-visible">
        {/* Background Image */}
        <Image
    ...
    "
        >
          ...
          px-4 py-1.5 rounded-md shadow-lg hover:bg-[#10284C] transition
        "
            >
      ...
      <div className="hidden lg:block min-h-screen ">
        ...
        {/* Header Bar */}
        <div className="bg-white border-gray-200 px-2 bg-gray-50 mt-10 lg:px-4">
          <div className="hidden lg:flex max-w-full mb-2 bg-gray-50    mt-32 mx-auto items-center gap-4">
