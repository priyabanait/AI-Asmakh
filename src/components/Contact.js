...
export default function MeetOurAgents() {
  ...
  return (
    <div>
      ...
      <div className="hidden md:flex w-full justify-center -mt-10 lg:-mt-5 relative z-20">
        <div
          className="
      grid w-full glass-effect p-4 lg:mx-40 rounded-md shadow-md gap-4
            ...
            >
              ...
              <div className="text-center mt-3 sm:mt-4 px-3 sm:px-4 pb-4 sm:pb-6">
                ...
                <div className="grid grid-cols-2 gap-2 lg:gap-2 mb-3 sm:mb-4">
                  {/* Box 1 */}
                  <div className="glass-effect shadow-md p-2 px-4 sm:px-6 md:px-8 rounded-md text-center">
                    ...
                    <p className="subheading text-[#10284C]">Properties</p>
                  </div>
                  ...
                  <div className="glass-effect shadow-md p-2 px-4 sm:px-6 md:px-8 rounded-md text-center">
                    ...
                    <div className="h-[1.5px] bg-gray-200 my-1 sm:my-2 md:my-2 mx-auto"></div>
                    <p className="subheading text-[#10284C]">Clients Served</p>
                  </div>
                </div>
