  ...
  return (
    ...
    >
      <div className="max-w-[1500px] w-full px-4 mx-auto 2xl:max-w-[1500px]">
        <div className="flex items-center justify-between relative h-full gap-4">
          {/* Mobile Logo */}
          ...
          <nav className="hidden lg:flex items-center gap-6 relative text-[#001730] font-medium flex-shrink-0" style={{ fontSize: '14px' }}>
                      ...
                      {dropdowns[item].map((sub, idx) => (
                        <li key={idx}>
                          <button
                            ...
                            className="block w-full text-left px-4 py-2 text-[#001730] hover:bg-white/60 transition-all duration-200 whitespace-nowrap"
                            style={{ fontSize: '14px' }}
                          >
                            {sub.label}
                          </button>
          ...
          {mobileMenuOpen && (
            <div
              className="lg:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-40 top-[62px]"
          ...
          {/* Mobile Menu */}
          <div
            className={`lg:hidden fixed top-[62px] left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-white/20 shadow-xl z-50 transition-all duration-300 ease-in-out overflow-hidden ${mobileMenuOpen
                ...
                <div key={item}>
                  ...
                  >
                    ...
                    {dropdowns[item] && (
                      <ChevronDown
                        size={16}
                        className={`transition-transform duration-300 ${mobileOpenDropdown === item ? 'rotate-180' : 'rotate-0'
                          }`}
                      />
                    )}
                  </button>
