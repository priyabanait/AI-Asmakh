...
BUY
 ...
 <section className="w-full bg-[#F5F7FA] py-16">
      <div className=" lg:mx-14 mx-auto px-6 text-center">
        ...
        {/* TITLE */}
        <h2 className="text-[28px] md:text-[32px] font-semibold tracking-wide text-[#10284C]">
          PRIVILEGE PROGRAM
        </h2>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 className="text-[18px] font-semibold text-[#10284C] mb-3">
                        {item.title}
                      </h3>
    ...
    <section className="w-full bg-white py-20">
      ...
      <div className="max-w-6xl mx-auto text-center px-6">
        <h2 className="text-[28px] md:text-[32px] text-[#10284C] font-semibold tracking-[1px]">
          PRIVILEGE PARTNERS
        </h2>
        <div className="w-[30%] h-[0.2px]  bg-gray-300 mx-auto my-4"></div>
      ...
      <div className="max-w-lg mx-auto text-center mt-24 px-6">
        <h3 className="text-[26px] md:text-[30px] font-semibold text-[#10284C]">
          SIGN IN
        </h3>
        <div className="w-[30%] h-[0.2px]  bg-gray-300 mx-auto my-4"></div>
        ...
        {/* SIGN IN BUTTON */}
        <button className="mt-8 w-full md:w-56 bg-[#10284C] text-white py-3 rounded-md font-medium flex items-center justify-between px-6  mx-auto hover:bg-[#0d2340] transition">
        ...
        <p className="text-gray-500 text-sm mt-4">
          ...
          <span className="text-[#10284C] font-semibold cursor-pointer">
            Sign Up
          </span>
        </p>
        <div className="w-[50%] h-[0.5px]  bg-gray-300 mx-auto my-4"></div>
        {/* PARTNER LOGIN */}
        <p className="text-[#10284C] font-semibold text-sm mt-2 cursor-pointer hover:text-[#10284C] transition">
          Partner Log In
        </p>
      </div>
    </section>
