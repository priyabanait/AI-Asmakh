...
export default function Profit() {
  ...
  return (
    ...
    "
      ...
      {/* Section Title + Cards */}
      <div className="relative w-full py-6 lg:py-12 2xl:py-14 3xl:py-16 4xl:py-20 5xl:py-24 px-4 lg:px-16 2xl:px-20 3xl:px-24 4xl:px-32 5xl:px-40 overflow-hidden">
        <h2
          id="my-heading"
          className="text-[18px] lg:text-[26px] 2xl:text-[32px] 3xl:text-[38px] 4xl:text-[44px] 5xl:text-[52px] font-semibold text-[#10284C] uppercase mb-2 text-center 3xl:mb-3 4xl:mb-4"
        >
          FEATURED PROPERTIES
        </h2>
        ...
        <div
          ref={scrollRef}
          className="flex gap-4 lg:gap-6 2xl:gap-7 3xl:gap-8 4xl:gap-10 5xl:gap-12 overflow-x-auto no-scrollbar scroll-smooth pb-6 2xl:pb-8 3xl:pb-10 4xl:pb-12 5xl:pb-14"
        >
        ...
        `}
            >
              {/* Image Section */}
              <div className="relative w-full h-[180px] lg:h-[220px] 2xl:h-[260px] 3xl:h-[300px] 4xl:h-[340px] 5xl:h-[400px]">
                <Image
                  src={property.image}
                  alt={property.title}
                  fill
              ...
              {/* Property Info */}
              <div className="py-2">
                <h3 className="font-semibold text-[#10284C] text-sm lg:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-1 leading-snug line-clamp-2">
                  {property.title}
                </h3>

                {/* Location */}
                <div className="flex items-center text-[#10284C] text-xs lg:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl mb-2 lg:mb-3">
                  <Image
                    src="/Vector.png"
                    alt="Location"
                    width={14}
                ...
                {/* Bed/Bath/Area Info */}
                <div className="flex items-center justify-between text-[#10284C] text-xs lg:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl mb-3 lg:mb-4 gap-1">
                  <div
                    className="flex items-center gap-1 shadow p-1.5 lg:p-2 2xl:p-3 3xl:p-3 4xl:p-4 5xl:p-5 lg:px-6 px-2 rounded-md"
                  ...
                  >
                    <Image
                      ...
                      width={14}
                      height={14}
                      className="lg:w-[18px] lg:h-[18px] 2xl:w-[22px] 2xl:h-[22px] 3xl:w-[26px] 3xl:h-[26px] 4xl:w-[30px] 4xl:h-[30px] 5xl:w-[36px] 5xl:h-[36px]"
                    />
                ...
                <div className="flex items-center justify-between gap-2">
                  <p className="text-[24px] lg:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl font-semibold text-[#10284C]">
                    {property.price}
                  </p>

                  <button className="bg-[#10284C] text-white text-xs lg:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl font-semibold px-3 lg:px-5 2xl:px-6 3xl:px-7 4xl:px-8 5xl:px-10 py-1.5 lg:py-2 2xl:py-3 3xl:py-3 4xl:py-4 5xl:py-5 rounded flex items-center gap-1 lg:gap-2 transition hover:bg-[#1b3a70]">
                    <Link
                    ...
                    >
                      ...
                      <FaArrowRight
                        size={12}
                        className="lg:w-[14px] lg:h-[14px] 2xl:w-[18px] 2xl:h-[18px] 3xl:w-[22px] 3xl:h-[22px] 4xl:w-[26px] 4xl:h-[26px] 5xl:w-[32px] 5xl:h-[32px] lg:ml-6 ml-1"
                      />
                    </Link>
                  </button>
                </div>
        ...
        <div className="flex justify-center mt-4 lg:mt-6 2xl:mt-8 3xl:mt-10 4xl:mt-12 5xl:mt-14">
          <button className="bg-[#10284C] text-white text-xs lg:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl font-semibold px-4 lg:px-5 2xl:px-6 3xl:px-7 4xl:px-8 5xl:px-10 py-1.5 lg:py-2 2xl:py-3 3xl:py-3 4xl:py-4 5xl:py-5 rounded flex items-center justify-center gap-2 transition hover:bg-[#1b3a70]">
            <span>View All</span>
            <FaArrowRight
              size={12}
        ...
        {showScrollButton && (
          <button
            onClick={scrollRight}
            className="absolute right-2 lg:right-4 2xl:right-6 3xl:right-8 4xl:right-10 5xl:right-12 top-1/2 transform -translate-y-1/2 
                     bg-white border border-gray-300 rounded-md p-2 lg:p-3 2xl:p-4 3xl:p-5 4xl:p-6 5xl:p-7 lg:px-6 2xl:px-8 3xl:px-10 4xl:px-12 5xl:px-14
                     shadow-md z-10 hover:shadow-lg transition"
          >
            <FaArrowRight className="text-[#10284C] w-6 h-6 lg:w-6 lg:h-6 2xl:w-8 2xl:h-8 3xl:w-10 3xl:h-10 4xl:w-12 4xl:h-12 5xl:w-14 5xl:h-14" />
          </button>
        )}
      </div>
