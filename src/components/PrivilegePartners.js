...
export default function Profit() {
  ...
  return (
    ...
    "
      ...
      "
          >
            <div>
              <h1 className="text-sm lg:text-2xl font-semibold leading-tight">
      ...
      {/* Section Title + Cards */}
      <div className="relative w-full py-6 md:py-8 lg:py-12 xl:py-14 2xl:py-14 3xl:py-16 4xl:py-20 5xl:py-24 px-4 md:px-8 lg:px-16 xl:px-18 2xl:px-20 3xl:px-24 4xl:px-32 5xl:px-40 overflow-hidden">
        <h2
          id="my-heading"
          className="text-[18px] md:text-[22px] lg:text-[26px] xl:text-[28px] 2xl:text-[32px] 3xl:text-[38px] 4xl:text-[44px] 5xl:text-[52px] font-semibold text-[#10284C] uppercase mb-2 md:mb-2 lg:mb-2 xl:mb-3 2xl:mb-3 3xl:mb-3 4xl:mb-4 5xl:mb-4 text-center"
        >
          FEATURED PROPERTIES
        </h2>
        <div className="flex-1 h-px bg-gray-300 my-3 md:my-3 lg:my-4 xl:my-4 2xl:my-5 3xl:my-6 4xl:my-7 5xl:my-8 mx-auto w-[60%] md:w-[40%] lg:w-[20%] mb-3 md:mb-3 lg:mb-4"></div>
        <p
          id="desc"
          className="
    text-gray-500 
  ...
  " style={{ fontSize: "clamp(13px, 0.8vw, 17px)" }}
        ...
        <div
          ref={scrollRef}
          className="flex gap-3 md:gap-4 lg:gap-6 xl:gap-6 2xl:gap-7 3xl:gap-8 4xl:gap-10 5xl:gap-12 overflow-x-auto no-scrollbar scroll-smooth pb-4 md:pb-6 lg:pb-6 2xl:pb-8 3xl:pb-10 4xl:pb-12 5xl:pb-14"
        >
          {properties.map((property, index) => (
            <div
              key={index}
              className={`
          w-[250px] md:w-[260px] lg:w-[280px] xl:w-[300px] 2xl:w-[350px] 3xl:w-[420px] 4xl:w-[480px] 5xl:w-[550px]
          p-3 md:p-3.5 lg:p-4 xl:p-4.5 2xl:p-5 3xl:p-6 4xl:p-7 5xl:p-8
        ...
        `}
            >
              {/* Image Section */}
              <div className="relative w-full h-[180px] md:h-[200px] lg:h-[220px] xl:h-[240px] 2xl:h-[260px] 3xl:h-[300px] 4xl:h-[340px] 5xl:h-[400px]">
                <Image
                  src={property.image}
                  alt={property.title}
                  fill
              ...
              {/* Property Info */}
              <div className="py-2">
                <h3 className="font-semibold text-[#10284C] text-sm md:text-sm lg:text-base xl:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl mb-1 leading-snug line-clamp-2">
                  {property.title}
                </h3>

                {/* Location */}
                <div className="flex items-center text-[#10284C] text-xs md:text-xs lg:text-sm xl:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl mb-2 md:mb-2 lg:mb-3">
                  <Image
                    src="/Vector.png"
                    alt="Location"
                    width={14}
                    height={14}
                    className="mr-1.5 md:mr-1.5 lg:mr-2 w-3.5 h-3.5 md:w-3.5 md:h-3.5 lg:w-4 lg:h-4 xl:w-4 xl:h-4 2xl:w-5 2xl:h-5 3xl:w-6 3xl:h-6 4xl:w-7 4xl:h-7 5xl:w-8 5xl:h-8"
                  />
                  <span className="line-clamp-1" style={{ fontSize: "clamp(13px, 0.8vw, 17px)" }}>{property.location}</span>
                </div>

                {/* Bed/Bath/Area Info */}
                <div className="flex items-center justify-between text-[#10284C] text-xs md:text-xs lg:text-sm xl:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl mb-3 md:mb-3 lg:mb-4 gap-1">
                  <div
                    className="flex items-center gap-1 shadow p-1.5 md:p-1.5 lg:p-2 xl:p-2 2xl:p-3 3xl:p-3 4xl:p-4 5xl:p-5 px-2 md:px-3 lg:px-6 rounded-md"
                  ...
                  >
                    <Image
                      ...
                      width={14}
                      height={14}
                      className="w-3.5 h-3.5 md:w-4 md:h-4 lg:w-[18px] lg:h-[18px] xl:w-[18px] xl:h-[18px] 2xl:w-[22px] 2xl:h-[22px] 3xl:w-[26px] 3xl:h-[26px] 4xl:w-[30px] 4xl:h-[30px] 5xl:w-[36px] 5xl:h-[36px]"
                    />
                ...
                <div
                  className="w-[100%]  h-[0.2px] bg-[#A6A6A6]  my-3 "
                  style={{ backgroundColor: '#A6A6A6' }}
                ></div>

                {/* Price and Button */}
                <div className="flex items-center justify-between gap-2">
                  <p className="text-base md:text-base lg:text-base xl:text-lg 2xl:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl font-semibold text-[#10284C]">
                    {property.price}
                  </p>

                  <button className="bg-[#10284C] text-white text-xs md:text-xs lg:text-sm xl:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl font-medium px-3 md:px-4 lg:px-5 xl:px-5 2xl:px-6 3xl:px-7 4xl:px-8 5xl:px-10 py-1.5 md:py-1.5 lg:py-2 xl:py-2 2xl:py-3 3xl:py-3 4xl:py-4 5xl:py-5 rounded-md flex items-center justify-between shadow-lg transition-all duration-300 hover:bg-[#002d52]">
                    <Link
                    ...
                    >
                      ...
                      <FaArrowRight
                        size={12}
                        className="w-3 h-3 md:w-3 md:h-3 lg:w-[14px] lg:h-[14px] xl:w-[14px] xl:h-[14px] 2xl:w-[18px] 2xl:h-[18px] 3xl:w-[22px] 3xl:h-[22px] 4xl:w-[26px] 4xl:h-[26px] 5xl:w-[32px] 5xl:h-[32px]"
                      />
                    </Link>
                  </button>
                </div>
        ...
        <div className="flex justify-center mt-4 md:mt-5 lg:mt-6 xl:mt-7 2xl:mt-8 3xl:mt-10 4xl:mt-12 5xl:mt-14">
          <button className="bg-[#10284C] text-white text-xs md:text-xs lg:text-sm xl:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl 5xl:text-2xl font-semibold px-4 md:px-4 lg:px-5 xl:px-5 2xl:px-6 3xl:px-7 4xl:px-8 5xl:px-10 py-1.5 md:py-1.5 lg:py-2 xl:py-2 2xl:py-3 3xl:py-3 4xl:py-4 5xl:py-5 rounded flex items-center justify-center gap-2 transition hover:bg-[#1b3a70]">
            <span>View All</span>
            <FaArrowRight
              size={12}
              className="w-3 h-3 md:w-3 md:h-3 lg:w-[14px] lg:h-[14px] xl:w-[14px] xl:h-[14px] 2xl:w-[18px] 2xl:h-[18px] 3xl:w-[22px] 3xl:h-[22px] 4xl:w-[26px] 4xl:h-[26px] 5xl:w-[32px] 5xl:h-[32px] ml-2 md:ml-4 lg:ml-20 xl:ml-20 2xl:ml-24 3xl:ml-28 4xl:ml-32 5xl:ml-40"
            />
          </button>
        </div>
        ...
        {showScrollButton && (
          ...
          >
            <FaArrowRight className="text-[#10284C] w-5 h-5 md:w-5 md:h-5 lg:w-6 lg:h-6 xl:w-6 xl:h-6 2xl:w-8 2xl:h-8 3xl:w-10 3xl:h-10 4xl:w-12 4xl:h-12 5xl:w-14 5xl:h-14" />
          </button>
        )}
      </div>
      ...
      <section className="bg-gray-100 py-8 lg:py-16 px-4 lg:px-24 relative overflow-visible flex justify-center">
        ...
        <div className="relative z-10 min-h-[400px] flex flex-col w-full">
          ...
          <div className="mt-0 text-center mb-[80px]">
            <h2 id="my-heading" className="text-[18px] lg:text-[22px] font-semibold text-[#10284C] uppercase mb-2 3xl:mb-3 4xl:mb-4">
      ...
      <section className="bg-white py-4 lg:py-16 px-4">
        ...
        <div className="hidden lg:block text-center mb-12">
          <h2 id="my-heading" className="text-[18px] lg:text-[22px] font-semibold text-[#10284C] uppercase mb-2 text-center 3xl:mb-3 4xl:mb-4">
          ...
          <div className="flex justify-center mt-8 space-x-2">
            {Array.from({ length: totalBlogSlides }).map((_, index) => (
              <button
                ...
                className={`w-2 h-2 transition-all duration-300 ${currentBlogSlide === index
                  ? "bg-[#10284C] ring-1 rounded-[1px] ring-[#10284C] ring-offset-2 scale-110"
                  : "bg-gray-300 hover:bg-gray-400 rounded-[1px]"
                  }`}
              ></button>
      ...
      <section className="relative w-full h-auto lg:h-screen flex items-center py-6 lg:py-0">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row w-full h-full px-4 lg:px-14 items-start justify-between py-6 lg:py-6 2xl:py-6 3xl:py-6 4xl:py-6 5xl:py-6">
          ...
          <div className="text-white lg:w-1/2 flex flex-col mt-6 lg:mt-8 2xl:mt-10 3xl:mt-12 4xl:mt-14 5xl:mt-16 mb-4 lg:mb-0 h-full">
            ...
            <h1 className="text-sm sm:text-2xl mx-20 lg:mx-0 text-uppercase md:text-[28px] lg:text-[28px] 2xl:text-[32px] 3xl:text-[36px] 4xl:text-[40px] 5xl:text-[44px] mb-2 md:mb-3 lg:mb-4 ">
      ...
      <section className="w-full py-8 lg:py-16 bg-white relative overflow-hidden">
        ...
        />
        <div className="max-w-[1400px] mx-auto px-4 lg:px-4 relative z-10">
          {/* Mobile Version */}
          <div className="block lg:hidden">
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 p-4 lg:p-6">
                      <h3 className="text-lg lg:text-2xl font-semibold text-[#10284C] mb-1">
                        {offices[mobileOfficeIndex].title}
                      </h3>
                      <p className="text-gray-500 text-xs lg:text-sm mb-3 lg:mb-4">
                        {offices[mobileOfficeIndex].subtitle}
                      </p>

                      {/* Separator Line */}
                      <div className="h-[1px] w-40 lg:w-60 bg-gray-400 mb-3 lg:mb-4" />
                      ...
                      <div className="space-y-1.5 lg:space-y-2">
                        <div className="flex items-center gap-2 text-gray-700 text-xs lg:text-sm">
                          ...
                          <span className="line-clamp-1">{offices[mobileOfficeIndex].address}</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-700 text-xs lg:text-sm">
                          <Phone className="w-3 h-3 lg:w-4 lg:h-4 text-gray-400" />
                          {offices[mobileOfficeIndex].phone}
                        </div>
                        <div className="flex items-center gap-2 text-gray-700 text-xs lg:text-sm">
                          <Mail className="w-3 h-3 lg:w-4 lg:h-4 text-gray-400" />
                          <span className="line-clamp-1">{offices[mobileOfficeIndex].email}</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-700 text-xs lg:text-sm">
                          <Clock className="w-3 h-3 lg:w-4 lg:h-4 text-gray-400" />
                          {offices[mobileOfficeIndex].timing}
                        </div>
                      </div>
                    </div>

                    {/* Right Section - Patterned Strip */}
                    <div className="w-16 lg:w-24 relative overflow-hidden z-10">
                      <Image
                        src="/images/BG_Form.png"
                        alt="Pattern"
                        fill
            ...
            <div className="flex justify-center mt-6 lg:mt-8 space-x-3">
              {offices.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 transition-all duration-300 ${mobileOfficeIndex === index
                    ? "bg-[#10284C] ring-1 rounded-[1px] ring-[#10284C] ring-offset-2 scale-110"
                    : "bg-gray-300 hover:bg-gray-400 rounded-[1px]"
                    }`}
                />
                  ...
                  {visibleOffices.map((office, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 p-6 relative z-10">
                        <h3 className="text-2xl font-semibold text-[#10284C] mb-1">
                          {office.title}
                        </h3>
                        <p className="text-gray-500 text-sm mb-4">{office.subtitle}</p>

                        {/* Separator Line */}
                        <div className="h-[1px] w-60 bg-gray-400 mb-4" />
                      ...
                      {/* Right Section - Patterned Strip */}
                      <div className="w-24 relative overflow-hidden z-10">
                        <Image
                          src="/images/BG_Form.png"
                          alt="Pattern"
                          fill
            ...
            <div className="flex justify-center mt-8 space-x-3">
              {Array.from({ length: totalOfficeSlides }).map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 transition-all duration-300 ${currentSlides === index
                    ? "bg-[#10284C] ring-1 rounded-[1px] ring-[#10284C] ring-offset-2 scale-110"
                    : "bg-gray-300 hover:bg-gray-400 rounded-[1px]"
                    }`}
                />
