...
export default function PropertyDetails() {
  ...
  <button className="flex items-center gap-2 text-[#10284C] font-semibold">
   ...
   <span className="ml-2 sm:ml-8">Back</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div className="bg-[#10284C] text-white p-4 sm:p-6 rounded-md shadow-md flex flex-col justify-center">
        ...
        <div className="bg-[#10284C] p-4 sm:p-6 rounded-md shadow-md flex items-center justify-center">
  <div className="flex gap-2 sm:gap-4 w-full">
    <button className="w-1/2 bg-gray-400 text-[#10284C] rounded-md font-semibold py-2 text-xs sm:text-base shadow">
      For Rent
    </button>
    ...
    <button className="w-1/2 bg-gray-400 text-[#10284C] rounded-md font-semibold py-2 text-xs sm:text-base shadow">
      ...
      <div className="flex justify-center items-center gap-4 sm:gap-6 mt-4 sm:mt-6">
        <button className="bg-white p-2 sm:p-3 rounded-md shadow-md border border-gray-500">
          <FaArrowLeft size={18} className="sm:w-[22px] sm:h-[22px] text-[#10284C]" />
        </button>
        <div className="text-[#10284C] tracking-widest text-sm sm:text-lg">- - - - -</div>
        <button className="bg-white p-2 sm:p-3 rounded-md shadow-md border border-gray-500">
          <FaArrowRight size={18} className="sm:w-[22px] sm:h-[22px] text-[#10284C]" />
        </button>
      </div>
    </div>
    </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-4">
            {[
              ...
              >
                ...
                <p className="font-semibold text-[#10284C] text-xs sm:text-base">{item.label}</p>
              </div>
            ))}
          </div>
          </div>
  ...
  {[
    ...
    >
      ...
      {/* VALUE BELOW */}
      <h3 className="text-[#10284C] text-base sm:text-xl font-semibold mt-1">
        {item.value}
      </h3>
    </div>
  ))}
...
<div className="mt-4 sm:mt-6 bg-white rounded-xl shadow p-0 h-[250px] sm:h-[300px] overflow-hidden">
  ...
  <div className="bg-white p-3 sm:p-4 rounded-md shadow text-xs sm:text-sm">
          ...
          {[
            ...
            >
              ...
              <div className="w-full lg:w-1/2 p-4 sm:p-6 flex flex-col justify-between">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-center text-[#10284C] mb-1">
                    {agent.name}
                  </h3>
                ...
                <div className="mt-4 flex flex-col gap-2">
                  <div className="flex flex-row gap-2">
                    <button className="flex-1 bg-[#10284C] text-white py-2 sm:py-2.5 rounded-md flex justify-between items-center px-3 sm:px-4 text-xs sm:text-sm font-medium hover:opacity-90 transition">
                      Call Agent 
                  ...
                  <button className="w-full bg-[#10284C] text-white py-2 sm:py-2.5 rounded-md flex justify-between items-center px-3 sm:px-4 text-xs sm:text-sm font-medium hover:opacity-90 transition">
                    Schedule Viewing 
                    <FaArrowRight size={12} className="sm:w-[14px] sm:h-[14px]"/>
                  </button>
                </div>
    ...
    <div className="relative w-full py-8 sm:py-12 px-4 lg:px-16 overflow-hidden">
      <h2 className="text-xl sm:text-[27px] md:text-[36px] lg:text-[36px] font-semibold text-[#10284C]  uppercase mb-2 text-center 3xl:mb-3 4xl:mb-4">
      Related Listings
        </h2>
          ...
          {properties.map((property, index) => (
            ...
            >
              ...
              <div className="p-3 sm:p-4">
                <h3 className="font-semibold text-[#10284C] text-sm sm:text-base mb-1 leading-snug line-clamp-2">
                  {property.title}
                </h3>

                {/* Location */}
                <div className="flex items-center text-[#10284C] text-xs sm:text-sm mb-3">
                  <Image
                    src="/Vector.png"
                    alt="Location"
                    width={16}
                ...
                {/* Bed/Bath/Area Info */}
                <div className="flex items-center justify-between text-[#10284C] text-xs sm:text-sm mb-4 gap-1 sm:gap-2">
                  <div className="flex items-center gap-1 bg-white shadow p-1.5 sm:p-2 px-3 sm:px-6 rounded-md">
                    <Image
                      src="/Icon (1).png"
                      alt="Beds"
                      width={18}
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
                  <p className="text-base sm:text-lg font-bold text-[#10284C]">
                    {property.price}
                  </p>

                  <button className="bg-[#10284C] text-white text-xs sm:text-sm font-semibold px-3 sm:px-5 py-1.5 sm:py-2 rounded flex items-center gap-2 transition hover:bg-[#1b3a70] w-full sm:w-auto justify-center sm:justify-start">
  <Link href="/propertydetails" className="flex items-center gap-2">
    ...
    <FaArrowRight size={12} className="sm:w-[14px] sm:h-[14px] sm:ml-6" />
        ...
        <div className="flex justify-center mt-4 sm:mt-6">
          <button className="bg-[#10284C] text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 rounded flex items-center justify-center gap-2 transition hover:bg-[#1b3a70]">
            <span>View All</span>
        ...
        {showScrollButton && (
          ...
          >
            <FaArrowRight
              className="text-[#10284C] w-5 h-5 sm:w-6 sm:h-6"
            />
          </button>
        )}
      </div>
