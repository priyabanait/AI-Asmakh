...
export default function Sale() {
  ...
  return (
    ...
    />
      ...
      {/* Mobile Map View */}
      <div className="block md:hidden w-full relative" style={{ height: "calc(100vh - 350px)", minHeight: "60vh" }}>
        {/* Los Angeles Map */}
        <iframe
      ...
      <div className="w-full hidden md:flex justify-center pt-10 py-10">
