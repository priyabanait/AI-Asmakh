...
export default function Sale() {
  ...
  return (
    ...
    />
      ...
      {/* Mobile Map View */}
      <div className="block md:hidden w-full mt-40 relative" style={{ height: "calc(100vh - 350px)", minHeight: "60vh" }}>
        {/* Los Angeles Map */}
        <iframe
      ...
      <div className="w-full hidden md:flex justify-center pt-20 py-10">
  ...
  <button className="flex items-center justify-center ml-10 bg-[#0B1F3A]/40 text-white px-6 py-3 rounded-md w-[180px] font-medium shadow-lg hover:bg-[#5c1eff] transition">
    <span>+ More Filters</span>
      ...
      <div className="hidden lg:block w-[100%] h-[1px] bg-gray-300 my-2  px-10"></div>
