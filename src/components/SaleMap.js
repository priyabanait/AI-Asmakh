                  ...
                  <div className="flex p-4 rounded-md">
                    ...
                    <div className="flex-1 p-4 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="flex items-center text-[#10284C] text-sm mb-5">
                          <Image
                            src="/Vector.png"
                            alt="Location"
                            width={12}
                        ...
                        <div className="flex items-center justify-between text-[#10284C] text-xs lg:text-sm mb-3 lg:mb-0 mt-4 gap-1">
