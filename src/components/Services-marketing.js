          ...
          <div className="glass-effect text-center rounded-lg shadow-lg p-4 sm:p-6 md:p-10 lg:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:mr-40 text-center">
              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                ...
                <p className="subheading text-[#10284C]">Increase in Property Views</p>
              </div>

              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                <p className="text-xl sm:text-2xl font-bold text-[#10284C]">60%</p>
                <div className="w-[70%] h-[1.5px] bg-gray-300 my-1 sm:my-2 mx-auto"></div>
                <p className="subheading text-[#10284C]">Faster Luxury Sale Times</p>
              </div>

              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                <p className="text-xl sm:text-2xl font-bold text-[#10284C]">25%</p>
                <div className="w-[70%] h-[1.5px] bg-gray-300 my-1 sm:my-2 mx-auto"></div>
                <p className="subheading text-[#10284C]">Higher Sale Prices Achieved</p>
              </div>

              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                <p className="text-xl sm:text-2xl font-bold text-[#10284C]">98%</p>
                <div className="w-[70%] h-[1.5px] bg-gray-300 my-1 sm:my-2 mx-auto"></div>
                <p className="subheading text-[#10284C]">Elite Client Satisfaction Rate</p>
              </div>
            </div>
          </div>
