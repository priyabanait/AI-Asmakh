      ...
      <section className="relative w-full bg-gray-200 min-h-screen flex items-center justify-center overflow-visible">
        ...
        <div className="absolute left-4 md:left-8 lg:left-12 top-1/2 transform -translate-y-1/2 z-20 w-[90%] md:w-[60%] lg:w-[60%]">
          <div className="glass-effect text-center rounded-lg shadow-lg p-4 sm:p-6 md:p-10 lg:text-left">
            ...
            {/* Title */}
            <h2 className="heading font-semibold text-[#10284C] mb-3 sm:mb-4 lg:mr-40">
              PROPERTY MANAGEMENT
            </h2>
            {/* Divider */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:mr-40 text-center">
              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                ...
                <p className="subheading text-[#10284C]">Properties Managed</p>
              </div>

              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                <p className="text-xl sm:text-2xl font-bold text-[#10284C]">15%</p>
                <div className="w-[70%] h-[1.5px] bg-gray-300 my-1 sm:my-2 mx-auto"></div>
                <p className="subheading text-[#10284C]">Average ROI Increase</p>
              </div>
              ...
              <div className="glass-effect rounded-lg shadow p-3 sm:p-4">
                ...
                <div className="w-[70%] h-[1.5px] bg-gray-300 my-1 sm:my-2 mx-auto"></div>
                <p className="subheading text-[#10284C]">Emergency Support</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <button
                className={`w-full py-2.5 rounded-md text-white font-medium flex items-center justify-between px-6 gap-2 transition ${plan.highlighted
