      ...
      <div className="container-custom">
        <div className="flex flex-wrap justify-around items-start gap-12 3xl:gap-16 4xl:gap-20">
          ...
          <div className="text-center mt-5 3xl:mt-8 4xl:mt-10 flex-1 min-w-[300px] 3xl:min-w-[350px] 4xl:min-w-[400px] max-w-[400px] 3xl:max-w-[450px] 4xl:max-w-[500px]">
            ...
            <div className="w-32 3xl:w-40 4xl:w-48 h-[0.5px] 3xl:h-[0.7px] 4xl:h-[1px] bg-gray-300 mx-auto mb-5 3xl:mb-6 4xl:mb-8"></div>
            ...
            <div className="w-32 3xl:w-40 4xl:w-48 h-[0.3px] 3xl:h-[0.5px] 4xl:h-[0.7px] mt-4 3xl:mt-6 4xl:mt-8 bg-gray-300 mx-auto mb-6 3xl:mb-8 4xl:mb-10"></div>
