      ...
      <div className="lg:hidden relative w-full min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 w-[90%] max-w-md ">
          <div className="bg-[#8C8C8CCC] backdrop-blur-md shadow-xl rounded-xl p-6 border border-gray-400">
            ...
            {/* Password */}
            <div className="mt-4">
              <label className="text-sm font-medium text-[#10284C]">Password</label>
              <input
                type="password"
            ...
            <div className="text-xs font-semibold mt-8 flex flex-col justify-between text-[#10284C] gap-2 text-center">
              <span>
                Forgot Password - <a className="text-[#10284C]">RESET</a>
              </span>

              <span>
                Do Not have an Account - <a className="text-[#10284C]">SIGN UP</a>
              </span>
            </div>
      ...
      <div className="hidden lg:flex relative w-full min-h-screen flex-row">
        ...
        >
          <div className="bg-[#8C8C8CCC] backdrop-blur-md shadow-xl rounded-xl p-10 border border-gray-400">
            ...
            <div className="text-xs font-semibold mt-8 flex flex-row justify-between text-[#10284C] gap-2 text-left">
              <span>
                Forgot Password - <a className="text-[#10284C]">RESET</a>
              </span>
