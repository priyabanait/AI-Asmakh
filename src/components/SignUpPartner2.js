        ...
        <div className="relative z-10 w-[90%] max-w-md">
          <div className="bg-[#8C8C8CCC] backdrop-blur-md shadow-xl rounded-xl p-6 border border-gray-400">
            ...
            <div className="grid grid-cols-1 gap-4 mt-6">
              ...
              {/* Name */}
              <div>
                <label className="text-sm font-medium text-[#10284C]">Name</label>
                <input
                  type="text"
              ...
              {/* Email */}
              <div>
                <label className="text-sm font-medium text-[#10284C]">Email</label>
                <input
                  type="email"
              ...
              {/* Phone */}
              <div>
                <label className="text-sm font-medium text-[#10284C]">Phone</label>
                <input
                  type="text"
              ...
              {/* Partnership ID */}
              <div>
                <label className="text-sm font-medium text-[#10284C]">Partnership ID</label>
                <input
                  type="text"
              ...
              {/* Password */}
              <div>
                <label className="text-sm font-medium text-[#10284C]">Create Password</label>
                <input
                  type="password"
            ...
            {/* Footer */}
            <div className="text-xs font-semibold mt-8 flex flex-col justify-center text-[#10284C] text-center">
              <span>
      ...
      <div className="hidden lg:flex relative w-full min-h-screen flex-row">
        ...
        <div className="absolute left-2/3 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="w-[500px] bg-[#8C8C8CCC] backdrop-blur-md shadow-xl rounded-xl p-10 border border-gray-400">
            ...
            {/* Footer */}
            <div className="text-xs font-semibold mt-8 flex justify-between text-[#10284C]">
              <span>
                Already have an Account - Sign In
              </span>
            </div>
